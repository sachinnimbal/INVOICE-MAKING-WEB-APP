                              ...
                              ?>
                                <tr>
                                  <td class="text-center align-middle m-1 p-1">
                                    <a class="myTooltip" href="view-product?id=<?= $row['id'] ?>" data-toggle="tooltip" 
                                        data-placement="bottom" 
                                        title="View"> 
                                  <?php
                                    if ($row['image'] == '') {
                                    ...
                                    ?>
                                    <p class="text-black m-0 p-0"><?= $row['product_code'] ?></p></a>
                                  </td>
                                  <td class="text-center align-middle">
                                    <a href="product-edit?id=<?= $row['id']; ?>" class="btn btn-sm btn-primary myTooltip" 
                                        data-toggle="tooltip" 
                                        data-placement="bottom" 
                                        title="Edit"><i class="bi bi-pencil-square"></i></a>
                                    <button type="button" class="btn btn-sm btn-danger deleteProduct myTooltip" data-toggle="tooltip" 
                                        data-placement="bottom" 
